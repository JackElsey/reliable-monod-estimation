...
def analyze_regression(model, x_data, y_data, meas_stdev, theta_hat, normalize=True):
...
def load_theta_hats(theta):
    ...
    fit_res_arr = np.load('exp5_alpha/fit_res/'+str(seed)+'.npy')
...
def calc_Q(theta):
    try:
        ...
        for i, theta_hat in enumerate(theta_hats):
            ...
            Q = analyze_regression(mrd_model, x_data, y_data, meas_stdev, theta_hat)
