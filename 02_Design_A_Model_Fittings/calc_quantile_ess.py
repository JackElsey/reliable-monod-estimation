...
if __name__ == "__main__":
    ...
    print('RAE percentile ess')
    print('5%:', az.ess(rae_data, method='quantile', prob=0.05).x.values)
    print('25%:', az.ess(rae_data, method='quantile', prob=0.25).x.values)
    print('50%:', az.ess(rae_data, method='quantile', prob=0.50).x.values)
    print('75%:', az.ess(rae_data, method='quantile', prob=0.75).x.values)
    print('95%:', az.ess(rae_data, method='quantile', prob=0.95).x.values)
    # print('RMOE r-hat')
    # print(az.rhat(rmoe_data).x.values)
    print('RMOE percentile ess')
    print('5%:',az.ess(rmoe_data, method='quantile', prob=0.05).x.values)
    print('25%:', az.ess(rmoe_data, method='quantile', prob=0.25).x.values)
    print('50%:', az.ess(rmoe_data, method='quantile', prob=0.50).x.values)
    print('75%:', az.ess(rmoe_data, method='quantile', prob=0.75).x.values)
    print('95%:', az.ess(rmoe_data, method='quantile', prob=0.95).x.values)
    ...
    #
    # # save percentiles
    # rmoe_percentiles = np.nanpercentile(rmoe_all, (5,25,50,75,95), axis=0)
    # rae_percentiles = np.nanpercentile(rae_all, (5,25,50,75,95), axis=0)
    # print(rmoe_percentiles)
    # np.save('rmoe_percentiles', rmoe_percentiles)
    # np.save('rae_percentiles', rae_percentiles)
